...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="{{asset('templates/datum/css/backend.css?v=1.0.0')}}">  </head>
  <body class="  ">
    <!-- loader Start -->
    <div id="loading">
      ...
      <div class="iq-sidebar  sidebar-default  ">
          <div class="iq-sidebar-logo d-flex align-items-end justify-content-between">
               <a href="../backend/index.html" class="header-logo">
                  <img src="{{asset('templates/datum/images/logo.png')}}" class="img-fluid rounded-normal light-logo" alt="logo">
                  <img src="{{asset('templates/datum/images/logo-dark.png')}}" class="img-fluid rounded-normal d-none sidebar-light-img" alt="logo">
                  <span>Datum</span>            
              </a>
                                                       ...
                                                       <div class="list-item d-flex justify-content-start align-items-start">
                                                           <div class="avatar">
                                                              <div class="avatar-img avatar-success avatar-20">
                                                                  <span><img class="avatar is-squared rounded-circle" src="{{asset('templates/datum/images/user/2.jpg')}}" alt="2.jpg"></span>
                                                              </div>
                                                          </div>
                                                          <div class="list-style-detail ml-2 mr-2">
...
<div class="container-fluid">
   <div class="row">
            ...
            <div class="card-body-list">               
               <ul class="list-style-3 mb-0">
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{asset('templates/datum/images/products/1')}}" alt="1.jpg">                        
                     </div>
                  ...
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{asset('templates/datum/images/products/2.jpg')}}" alt="2.jpg">                        
                     </div>
                     <div class="list-style-detail ml-3 mr-2">
                  ...
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{asset('templates/datum/images/products/13.jpg')}}" alt="3.jpg">                        
                     </div>
                     <div class="list-style-detail ml-3 mr-2">
                  ...
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{asset('templates/datum/images/products/4.jpg')}}" alt="4.jpg">                        
                     </div>
                     <div class="list-style-detail ml-3 mr-2">
                     ...
                     <tbody>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{asset('templates/datum/images/user/2.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{asset('templates/datum/images/user/5.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{asset('templates/datum/images/user/1.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                                 <div>Max Lynn</div>
                              </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{asset('templates/datum/images/user/3.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                                 <div>Danniw Yatt</div>
                              </div>
    ...
    <!-- Emoji picker -->
    <script src="{{asset('templates/datum/vendor/emoji-picker-element/index.js')}}" type="module"></script>
    
    
    <!-- app JavaScript -->
    <script src="{{asset('templates/datum/js/app.js')}}"></script>  </body>
</html>