         ...
         <div class="card card-block p-card">
            <div class="profile-box">
               <div class="profile-card rounded">
                  <img src="{{asset('templates/datum/images/user/1.jpg')}}" alt="profile-bg"
                     class="avatar-100 rounded d-block mx-auto img-fluid mb-3">
                  <h3 class="font-600 text-white text-center mb-0">{{$user_details->full_name}}</h3>
               ...
               <div class="pro-content rounded">
                  <div class="d-flex align-items-center mb-3">
                     ...
                     <p class="mb-0 eml">{{$user_details->email}}</p>
                  </div>
                  <div class="d-flex align-items-center mb-3">
                     <div class="p-icon mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     ...
                     <p class="mb-0">{{$user_details->phone}}</p>
                  </div>
                  <div class="d-flex align-items-center mb-3">
                     <div class="p-icon mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     ...
                     <p class="mb-0">{{$user_details->address}}</p>
                  </div>
